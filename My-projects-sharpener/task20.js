...
<html>
    <head>
        ...
        <meta name="description" content="Unique HTTPS endpoint automatically generated on first visit. Ready to receive GET, POST, PUT and DELETE requests to Create, Read, Update and Delete any REST resource.">
        ...
        <div class="columns">
            <div class="column has-text-centered">
                ...
                <p class="has-text-justified">
                    ...
                    <a href='https://crudcrud.com/api/f6212d6ab9064235a32dfd697eee99f7/unicorns' target="_blank" rel="noopener noreferrer">
                ...
                <p class="has-text-justified">
                    ...
                    individual entities from your resources. See the <a href="#requests-table">Summary Table</a> for details.
                </p>
            </div>
            <div class="column">
